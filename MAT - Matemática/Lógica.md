...
- **Propriedade 2 - Lei da dupla Negação**: $\text{\textasciitilde}(\text{\textasciitilde}p) \iff p$
...
- **Propriedade 3 - Princípio do terceiro excluído** - Dada uma proposição $p$, a proposição $p \lor \text{\textasciitilde}p$ é verdadeira.
...
**Importante! $p \implies q \iff \text{\textasciitilde}p \lor q$**
    $$ \begin{array}{ccc}
    p & q & p \implies q \\
    \color{green}V & \color{green}V & \color{green}V \\
    \color{green}V & \color{red}F & \color{red}F \\
...
- **Propriedade 5** - Dadas proposições $p$ e $q$, a proposição $\text{\textasciitilde}(p \implies q)$ é equivalente à proposição $p \land \text{\textasciitilde}q$.
...
- **Propriedade 8** - Dadas proposições $p$ e $q$, $\text{\textasciitilde}(p \land q) \iff \text{\textasciitilde}p \lor \text{\textasciitilde}q$ e $\text{\textasciitilde}(p \lor q) \iff \text{\textasciitilde}p \land \text{\textasciitilde}q$. Estas equivalências designam-se por **Primeiras Leis de Morgan**.
...
- **Propriedade 12** - Dadas duas proposições $p$ e $q$, a proposição $p \implies q$ é equivalente à proposição $\text{\textasciitilde}q \implies \text{\textasciitilde}p$
    - $\text{\textasciitilde}q \implies \text{\textasciitilde}p$ é a **implicação contrarrecíproca** da implicação $p \implies q$
