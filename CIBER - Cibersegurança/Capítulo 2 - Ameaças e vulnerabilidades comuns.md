...
1. Inspecionar componentes internas de SW suspeito:
...
2. Estudo de comportamento de SW suspeito:
...
- Ataques por Buffer Overflow com 2 variantes possiveis:
    ...
    2. *Overflow na pilha* - Overflow explorando a zona de memória onde são tipicamente guardados os argumentos, variáveis locais e endereço de retorno das funções (pilha)
